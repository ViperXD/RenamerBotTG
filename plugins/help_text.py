...
async def start_user(bot, update):
  # logger.info(update)
    ...
    buttons = [[ InlineKeyboardButton(text="MY Dev👨‍🔬", url="https://t.me/pot"), InlineKeyboardButton(text="⭕️ Channel ⭕️", url="https://t.me/teegn")], [ InlineKeyboardButton('⚙️ Help', callback_data='help_back')], 
